...
<form action="<?php echo bp_displayed_user_domain() . bp_get_settings_slug() . '/general'; ?>" method="post" class="standard-form" id="settings-form">
    ...
    <input type="email" name="email" id="email" value="<?php echo bp_get_displayed_user_email(); ?>" class="settings-input" readonly="readonly" style="background-color: #f0f0f0; cursor: not-allowed;" />
    <p class="description" style="margin-top: 4px; padding: 8px 12px; background-color: #f7f7f7; border-left: 4px solid #0073aa; font-size: 13px; color: #555;">
        <?php printf( __( 'To change your email, contact us at %s.', 'buddypress' ), '<a href="mailto:hello@hcommons.org">hello@hcommons.org</a>' ); ?>
    </p>
