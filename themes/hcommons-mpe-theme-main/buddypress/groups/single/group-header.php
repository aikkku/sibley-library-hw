...
<div id="cover-image-container">
	...
	if ( ! empty( $cover_image_url ) ) {
		$cover_style = ' style="background-image: url(' . esc_url( $cover_image_url ) . '); background-size: cover; background-position: center; display: none !important;"';
	} else {
	    $cover_style = ' style="display: none !important;"';
	}
	?>
